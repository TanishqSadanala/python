...
class Application():
    ...
    def FPS_score_display(self):
        fps_font = pygame.font.SysFont(Window_Config['Font'], 20)
        self.FPScount = fps_font.render(f"FPS:{self.fps()}", Window_Config['fontColor'], '#B0B0B0')
        score_font = pygame.font.SysFont(Window_Config['Font'], 20)
        self.Scorecount = score_font.render(f"Score:{self.ScoreCount}", Window_Config['fontColor'], '#B0B0B0')
